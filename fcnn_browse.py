...
if __name__ == '__main__':
    ...
    focal_cnn.browse(image_path,output_dir=args.output_dir,model_path='./outputs-0.ckpt/0-81600',n=5,normal_size=224,focal_degree=0,method='quick',review=False,photo='raw',admin=False)